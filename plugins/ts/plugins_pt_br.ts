...
first base, second base, first target, second target.</source>
            <translation>Se a opção 'Manter objetos originais' estiver marcada, o comando Alinhar copiará, em vez de mover, os objetos selecionados.
...
Align will prompt for the alignment points in the order
first base, second base, first target, second target.</source>
            <translation>Se a opção 'Manter objetos originais' estiver marcada, a função 'Alinhar' copiará, em vez de mover, os objetos selecionados.
Se a opção 'Especificar pontos base primeiro' estiver marcada, a função 'Alinhar' solicitará os pontos de alinhamento na seguinte ordem: primeiro ponto base, segundo ponto base, primeiro ponto de destino, segundo ponto de destino.</translation>
        </message>
        <message>
