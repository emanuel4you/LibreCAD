...
first base, second base, first target, second target.</source>
            <translation>Якщо встановлено прапорець «Зберігати вихідні об’єкти», функція «Вирівняти» копіюватиме, а не переміщатиме вибрані об’єкти.
...
first base, second base, first target, second target.</source>
            <translation>Якщо встановлено прапорець «Зберігати вихідні об’єкти», функція «Вирівняти» копіюватиме, а не переміщатиме вибрані об’єкти.
Якщо встановлено прапорець «Спочатку вказати базові точки», функція «Вирівняти» запитуватиме точки вирівнювання в такому порядку: спочатку базова точка, потім друга базова точка, потім перша цільова точка, потім друга цільова точка.</translation>
        </message>
        <message>
