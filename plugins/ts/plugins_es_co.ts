...
first base, second base, first target, second target.</source>
            <translation>Si está marcada la opción 'Mantener objetos originales', la función de alineación copiará en lugar de mover los objetos seleccionados.
...
Align will prompt for the alignment points in the order
first base, second base, first target, second target.</source>
            <translation>Si está marcada la opción 'Mantener objetos originales', la función Alinear copiará en lugar de mover los objetos seleccionados.
Si está marcada la opción 'Especificar primero los puntos base', la función Alinear solicitará los puntos de alineación en el siguiente orden: primero el punto base, luego el segundo punto base, luego el primer punto de destino y, finalmente, el segundo punto de destino.</translation>
        </message>
        <message>
