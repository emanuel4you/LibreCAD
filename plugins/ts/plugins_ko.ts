...
first base, second base, first target, second target.</source>
            <translation>‘원래 객체 유지’가 선택된 경우, 정렬은 선택한 객체를 이동하는 대신 복사합니다.
...
Align will prompt for the alignment points in the order
first base, second base, first target, second target.</source>
            <translation>정렬 시 '원래 객체 유지'가 선택되어 있으면 정렬 기능은 선택한 객체를 이동하는 대신 복사합니다.
'기준점 먼저 지정'이 선택되어 있으면 정렬 기능은 기준점, 두 번째 기준점, 첫 번째 대상, 두 번째 대상 순서로 정렬 지점을 묻습니다.</translation>
        </message>
        <message>
