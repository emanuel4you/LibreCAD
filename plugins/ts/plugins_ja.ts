...
first base, second base, first target, second target.</source>
            <translation>「元のオブジェクトを保持する」にチェックが入っている場合、配置機能は選択したオブジェクトを移動するのではなく、コピーします。
...
Align will prompt for the alignment points in the order
first base, second base, first target, second target.</source>
            <translation>「元のオブジェクトを保持」にチェックが入っている場合、配置機能は選択したオブジェクトを移動するのではなく、コピーします。
「基準点を最初に指定」にチェックが入っている場合、配置機能は、最初に基準点、次にターゲット点を指定する順序で、配置ポイントの入力を促します。</translation>
        </message>
        <message>
