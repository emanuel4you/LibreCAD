...
first base, second base, first target, second target.</source>
            <translation>Если установлена опция «Сохранять исходные объекты», функция «Выровнять» будет копировать, а не перемещать выбранные объекты.
...
Align will prompt for the alignment points in the order
first base, second base, first target, second target.</source>
            <translation>Если установлена опция «Сохранять исходные объекты», то функция «Выровнять» будет копировать, а не перемещать выбранные объекты.
Если установлена опция «Сначала указать базовые точки», то функция «Выровнять» будет запрашивать точки выравнивания в следующем порядке: сначала базовая точка, затем вторая базовая точка, первая целевая точка, вторая целевая точка.</translation>
        </message>
        <message>
