...
#ifndef __SLIDE_RECORDS_VISITOR_QPIXMAP_DRAWER_HPP__
#define __SLIDE_RECORDS_VISITOR_QPIXMAP_DRAWER_HPP__
...
class SlideRecordsVisitorQPainterDrawer : public SlideRecordsVisitor {
public:
    SlideRecordsVisitorQPainterDrawer(QPainter* painter,
...
#endif // __SLIDE_RECORDS_VISITOR_QPIXMAP_DRAWER_HPP__
