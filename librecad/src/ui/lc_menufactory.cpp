...
void LC_MenuFactory::createDeveloperMenu(QMenuBar *menu_bar, QList<QMenu *> &topMenuMenus){
    ...
    m_menuDeveloper->addSeparator();
    m_menuDeveloper->addAction(ag_manager->getActionByName("LoadLisp"));
    m_menuDeveloper->addAction(ag_manager->getActionByName("LibreLisp"));
    m_menuDeveloper->addSeparator();
    m_menuDeveloper->addAction(ag_manager->getActionByName("LoadPython"));
    m_menuDeveloper->addAction(ag_manager->getActionByName("LibrePython"));
