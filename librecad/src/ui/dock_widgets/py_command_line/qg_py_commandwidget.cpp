 ...
 */
QG_Py_CommandWidget::QG_Py_CommandWidget(QG_ActionHandler *action_handler, QWidget* parent, const char* name, Qt::WindowFlags fl)
    : QWidget(parent, fl)
    , m_actionHandler(action_handler)
{
    setObjectName(name);
    setupUi(this);
    connect(leCommand, &QG_Py_CommandEdit::command, this, &QG_Py_CommandWidget::handleCommand);
    connect(leCommand, &QG_Py_CommandEdit::escape, this, &QG_Py_CommandWidget::escape);
    connect(leCommand, &QG_Py_CommandEdit::focusOut, this, &QG_Py_CommandWidget::setNormalMode);
    connect(leCommand, &QG_Py_CommandEdit::focusIn, this, &QG_Py_CommandWidget::setCommandMode);
    connect(leCommand, &QG_Py_CommandEdit::spacePressed, this, &QG_Py_CommandWidget::spacePressed);
    connect(leCommand, &QG_Py_CommandEdit::tabPressed, this, &QG_Py_CommandWidget::tabPressed);
    connect(leCommand, &QG_Py_CommandEdit::clearCommandsHistory, teHistory, &CommandHistory::clear);
    connect(leCommand, &QG_Py_CommandEdit::message, this, &QG_Py_CommandWidget::appendHistory);
