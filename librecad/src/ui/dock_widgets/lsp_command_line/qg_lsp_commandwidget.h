...
public:
    QG_Lsp_CommandWidget(QG_ActionHandler *action_handler, QWidget *parent = nullptr, const char *name = nullptr, Qt::WindowFlags fl = {});
    ...
    void setPrompt(const QString& p) { leCommand->setPrompt(p); leCommand->doProcess(true);}
    void doProcess(bool proc) { leCommand->doProcess(proc);}
