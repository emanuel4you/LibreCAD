 ...
 */
QG_Lsp_CommandWidget::QG_Lsp_CommandWidget(QG_ActionHandler *action_handler, QWidget* parent, const char* name, Qt::WindowFlags fl)
    : QWidget(parent, fl)
    , m_actionHandler(action_handler)
{
    setObjectName(name);
    setupUi(this);
    connect(leCommand, &QG_Lsp_CommandEdit::command, this, &QG_Lsp_CommandWidget::handleCommand);
    connect(leCommand, &QG_Lsp_CommandEdit::escape, this, &QG_Lsp_CommandWidget::escape);
    connect(leCommand, &QG_Lsp_CommandEdit::focusOut, this, &QG_Lsp_CommandWidget::setNormalMode);
    connect(leCommand, &QG_Lsp_CommandEdit::focusIn, this, &QG_Lsp_CommandWidget::setCommandMode);
    connect(leCommand, &QG_Lsp_CommandEdit::spacePressed, this, &QG_Lsp_CommandWidget::spacePressed);
    connect(leCommand, &QG_Lsp_CommandEdit::tabPressed, this, &QG_Lsp_CommandWidget::tabPressed);
    connect(leCommand, &QG_Lsp_CommandEdit::clearCommandsHistory, teHistory, &CommandHistory::clear);
    connect(leCommand, &QG_Lsp_CommandEdit::message, this, &QG_Lsp_CommandWidget::appendHistory);
