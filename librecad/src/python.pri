...
SWIG_FLAGS += \
    -v -c++ -python -DDEVELOPER -w302,314,325,503,520,350,351,383,389,394,395,401,402,404,412,476,509,512,504
...
win32 {
    ...
    PYTHON_LIB = "$${PYTHON_PATH}/libs/python$${PYTHON_VERSION}.lib"
